      ...
      >
        ...
        <View style={styles.heroCard}>
          ...
          <Text style={styles.heroDesc}>
            Enterprise-grade QR threat intelligence powered by dual AI models (ML + DL) with
            transparent SHAP explanations. Protect yourself from malicious QR codes before
            they can cause harm.
          </Text>
        ...
        <View style={styles.card}>
          {[
            ...
            <View key={i} style={[styles.riskRow, i < 2 && styles.riskRowBorder]}>
        ...
        <Text style={styles.footer}>
          © 2025 QRShield Pro. All rights reserved.{'\n'}
